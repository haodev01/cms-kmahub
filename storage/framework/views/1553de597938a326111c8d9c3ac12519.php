...
<div id="sidebar" class="active">
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                <li class="sidebar-item <?php echo e(NavigationHelper::isActive(['admin'])); ?> ">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="sidebar-item  <?php echo e(NavigationHelper::isActive(['admin/course-categories*'])); ?> ">
                    <a href="<?php echo e(route('course-categories.index')); ?>" class='sidebar-link'>
                        <i class="bi bi-stack"></i>
                        <span>Quản lý danh mục</span>
                    </a>
                </li>
                <li class="sidebar-item  <?php echo e(NavigationHelper::isActive(['admin/courses*'])); ?>  ">
                    <a href="<?php echo e(route('courses.index')); ?>" class='sidebar-link'>
                        <i class="bi bi-grid-1x2-fill"></i>
                        <span> Quản lý khóa học</span>
                    </a>
                </li>
                <li class="sidebar-item  <?php echo e(NavigationHelper::isActive(['admin/sections*'])); ?>  ">
                    <a href="<?php echo e(route('sections.index')); ?>" class='sidebar-link'>
                        <i class="bi bi-grid-1x2-fill"></i>
                        <span>Quản lý chương</span>
                    </a>
                </li>
                <li class="sidebar-item  <?php echo e(NavigationHelper::isActive(['admin/lessons*'])); ?>  ">
...
<?php /**PATH /Users/traiit/Desktop/haodev.com/lms_dashboard/resources/views/admin/blocks/sidebar.blade.php ENDPATH**/ ?>